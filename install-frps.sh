...
wget -P /tmp "https://github.com/fatedier/frp/releases/download/v${release}/${frp_package}.tar.gz"
...
echo "The frp server has been installed! Your must change your token in `/usr/local/etc/frp/frps.toml` for security!"
